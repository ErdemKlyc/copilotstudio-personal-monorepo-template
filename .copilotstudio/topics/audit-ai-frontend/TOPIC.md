...
- "make this responsive and accessible"
- "review design system drift"
...
1. Establish the local contract.
   ...
   - If a browser-automation action is registered on this agent (see `references/workflows.md`), use it and follow its own operating instructions; this topic decides what to inspect, not browser mechanics.
...
- When auditing shadcn/ui projects, preserve semantic component usage and tokens.
